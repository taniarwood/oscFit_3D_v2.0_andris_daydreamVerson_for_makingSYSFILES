...
#                                user = 'TryOneLoaderSystemacis_flat_uncontained',
				user = 'Chi2msu_no_background_noData_baselineONLY_flat_uncontained_numu_nue_both_albrecht_muons_too_DPM_h3a',
   ...
   #weight_keys = ['tweight_e', 'tweight_mu_k', 'tweight_mu_p'],
				...
				weight_keys = ['tweight_syb23_GH_e_jaspert', 'tweight_syb23_GH_mu_k_jaspert', 'tweight_syb23_GH_mu_p_jaspert'],
